...
############################################################
library(EdgeR)
counts <- read.delim("~/GDrive files/foxh1 and hdac1/hdac1 rna seq/endoderm/endoderm_raw_counts.txt", header=T)
head(counts)
...
write.table(downgenes,file="~/GDrive files/foxh1 and hdac1/hdac1 rna seq/endoderm/VG_downDEgene_names.txt", quote = FALSE)
upgenes <- DElist1[which(DElist1$logFC>0),]
write.table(upgenes,file="~/GDrive files/foxh1 and hdac1/hdac1 rna seq/endoderm/VG_upDEgene_names.txt", quote = FALSE)
#####################################################################
###########################volcano plot##############################
#####################################################################
...
geneOfinterest <- c("bmp4", "tbx2", "gata2", "ascl1", "sox2", 
                    "nodal3.1", "osr1", "tbxt.2", "sox9", "foxa2")
...
vp <- ggplot(data=volTable, aes(x=logFC, y=-log10(FDR))) + 
  ...
  geom_text_repel(data = geneOfinterestList, 
                  ...
                  max.overlaps = 20)
vp
ggsave('C:/Users/latro/Desktop/foxh1 and hdac1/hdac1 rna seq/endoderm/DE_volcanoPlot.tiff', vp, device = "tiff", dpi = 500)
################################################################
...
ggsave('C:/Users/latro/Desktop/foxh1 and hdac1/hdac1 rna seq/endoderm/endoderm_upGene_hp.tiff', hp, device = "tiff", dpi = 500)
...
hp <- pheatmap(         downrld1, 
                        ...
                        clustering_method = "ward.D2", 
                        col=colorRampPalette(rev(brewer.pal(9,"RdBu")))(255))
ggsave('C:/Users/latro/Desktop/foxh1 and hdac1/hdac1 rna seq/endoderm/endoderm_downGene_hp.tiff', hp, device = "tiff", dpi = 500)
##################################################
###################violin plot####################
##################################################
...
vlp
ggsave('C:/Users/latro/Desktop/foxh1 and hdac1/hdac1 rna seq/endoderm/endoderm_upGene_violinPlot.tiff', vlp, device = "tiff", dpi = 500)
#############t-test--unpaired############
...
vlp <- ggplot(downlogtpm1_vlpTable, aes(x= type, y= logTPM, fill= type))+ 
  ...
  theme(axis.title = element_blank())
vlp
ggsave('C:/Users/latro/Desktop/foxh1 and hdac1/hdac1 rna seq/endoderm/endoderm_downGene_violinPlot.tiff', vlp, device = "tiff", dpi = 500)
#############t-test--unpaired############
