################################################################################
##################Compare TSA DEgenes and VPA DEgenes in AC#####################
################################################################################
tsa_degene <- read.delim("~/GDrive files/foxh1 and hdac1/Compare VPA and TSA/AC/DEgene_TSA_AC.txt", header=T)
vpa_degene <- read.delim("~/GDrive files/foxh1 and hdac1/Compare VPA and TSA/AC/DEgene_VPA_AC.txt", header=T)

tsa_tpmTable <- read.delim("~/GDrive files/foxh1 and hdac1/Compare VPA and TSA/AC/ectoderm_TPM_DMSO_vs_TSA.txt", header=T)
vpa_tpmTable <- read.delim("~/GDrive files/foxh1 and hdac1/Compare VPA and TSA/AC/ectoderm_TPM_h2o_vs_VPA.txt", header=T)
...
tsa_only_hp <- pheatmap(log(reordered_tsa_only_gene_tpm+1, 2), 
                        ...
                        gaps_col = 4,
                        col=colorRampPalette(rev(brewer.pal(11,"PuOr")))(255))
ggsave('~/GDrive files/foxh1 and hdac1/Compare VPA and TSA/AC/hp_tsa_only_Degenes.tiff', tsa_only_hp, device = "tiff", dpi = 300)
...
shared_hp <- pheatmap(log(shared_gene_tpm+1, 2), 
                        ...
                        gaps_col = 4,
                        col=colorRampPalette(rev(brewer.pal(11,"PuOr")))(255))
ggsave('~/GDrive files/foxh1 and hdac1/Compare VPA and TSA/AC/hp_shared_Degenes.tiff', shared_hp, device = "tiff", dpi = 300)
...
vpa_only_hp <- pheatmap(log(reordered_vpa_only_gene_tpm+1, 2), 
                        ...
                        gaps_col = 4,
                        col=colorRampPalette(rev(brewer.pal(11,"PuOr")))(255))
ggsave('~/GDrive files/foxh1 and hdac1/Compare VPA and TSA/AC/hp_vpa_only_Degenes.tiff', vpa_only_hp, device = "tiff", dpi = 300)
