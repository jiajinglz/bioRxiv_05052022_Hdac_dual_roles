...
######################Heatmap for GO#########################
#############################################################
list <- read.csv("~/GDrive files/foxh1 and hdac1/Compare VPA and TSA/germ layer specific/GO_AllLists.csv")
...
ggsave('~/GDrive files/foxh1 and hdac1/Compare VPA and TSA/germ layer specific/GO_heatmap.tiff', p, device = "tiff", dpi = 200, width = 40, height = 20, units = c("cm"))
