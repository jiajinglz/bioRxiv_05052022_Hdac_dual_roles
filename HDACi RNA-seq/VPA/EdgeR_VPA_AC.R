...
############################################################
library(edgeR)
counts <- read.delim("~/GDrive files/foxh1 and hdac1/vpa rna/AC/st105_ut_vpa_ac_counts.txt", header=T)
...
write.table(DElist1,file="~/GDrive files/foxh1 and hdac1/vpa rna/AC/DE_gene_stat_VPA.txt", quote = FALSE, sep = "\t")
######export table######
downgenes <- DElist1[which(DElist1$logFC<0),]
write.table(downgenes,file="~/GDrive files/foxh1 and hdac1/vpa rna/AC/ac_downgenes_1_2.txt", quote = FALSE, sep = "\t")
upgenes <- DElist1[which(DElist1$logFC>0),]
write.table(upgenes,file="~/GDrive files/foxh1 and hdac1/vpa rna/AC/ac_upgenes_1_2.txt", quote = FALSE, sep = "\t")

################################################################################
#############################Compare with TSA###################################
################################################################################
ac_up_1_2 <- read.delim("~/GDrive files/foxh1 and hdac1/vpa rna/AC/ac_upgenes_1_2.txt", header=T)
ac_up_1_3 <- read.delim("~/GDrive files/foxh1 and hdac1/vpa rna/AC/ac_upgenes_1_3.txt", header=T)
ac_up_2_3 <- read.delim("~/GDrive files/foxh1 and hdac1/vpa rna/AC/ac_upgenes_2_3.txt", header=T)
ac_tsa_up <- read.delim("~/GDrive files/foxh1 and hdac1/hdac1 rna seq/ectoderm/ac_tsa_upDEgenes.txt", header=T)

ac_down_1_2 <- read.delim("~/GDrive files/foxh1 and hdac1/vpa rna/AC/ac_downgenes_1_2.txt", header=T)
ac_down_1_3 <- read.delim("~/GDrive files/foxh1 and hdac1/vpa rna/AC/ac_downgenes_1_3.txt", header=T)
ac_down_2_3 <- read.delim("~/GDrive files/foxh1 and hdac1/vpa rna/AC/ac_downgenes_2_3.txt", header=T)
ac_tsa_down <- read.delim("~/GDrive files/foxh1 and hdac1/hdac1 rna seq/ectoderm/ac_tsa_downDEgenes.txt", header=T)
